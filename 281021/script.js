...
function startGame() {
    ...
    if (enterCabin) {
        let porridgeChoice = +prompt('You walk into the cabin and see a lovely kitchen. On the table are three bowls of porridge. Do you try 1 (hot), 2 (cold) or 3 (just right)?');
        ...
        switch (porridgeChoice) {
            ...
            case 3:
                ...
                if (chairChoice.toLowerCase() === 'big') {
                    ...
                    let bedChoice = prompt('You walk into the next room over and see three beds, a (BIG) one, a (MEDIUM) one and a (SMALL) one. Which one do you choose?');
